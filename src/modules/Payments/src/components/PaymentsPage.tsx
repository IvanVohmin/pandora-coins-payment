        ...
        return (
            <main className="flex min-h-[79vh] w-full items-center justify-center px-4">
                <div className="flex max-w-md flex-col items-center text-center">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Произошла ошибка</h1>
        ...
        return (
            <main className="flex min-h-[79vh] w-full items-center justify-center px-4">
                <div className="flex max-w-md flex-col items-center text-center">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Нет неоплаченных платежей</h1>
                    ...
                    <Card key={payment.id} className="mt-4">
                        ...
                        <CardContent>
                            <div className="mb-4 text-center">
                                <p className="text-sm text-muted-foreground">Введите на сервере:</p>
                                <div className="relative mt-2 cursor-default">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => copyCode(payment.operationId)}
                                    >
